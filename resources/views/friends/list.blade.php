...
<head>
    ...
    <style>
        ...
        .friend-item { display: flex; align-items: center; gap: 16px; padding: 16px 0; border-bottom: 1px solid #f3f3f3; }
        ...
        .friend-info { flex: 1; }
        .friend-name { font-weight: 600; font-size: 1.1rem; }
        .friend-meta { color: #888; font-size: 0.95rem; }
        .action-btn { padding: 8px 20px; border-radius: 18px; border: none; background: #28a745; color: #fff; font-weight: 500; cursor: pointer; transition: background 0.2s; text-decoration:none; display:inline-block; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <ul class="friend-list">
            ...
            <li class="friend-item">
                ...
                @if(in_array($f->id_user, $friendIds))
                    <span class="friend-status" style="color:#28a745;font-weight:600;">Bạn bè</span>
                @else
                    <button class="action-btn add-friend-btn" data-id="{{ $f->id_user }}"><i class="fas fa-user-plus"></i> Kết bạn</button>
                @endif
            </li>
            @endforeach
        </ul>
